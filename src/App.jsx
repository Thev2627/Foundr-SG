...
export default function App() {
  ...
  if(!portal) return (
    <div style={{...s.page,...s.center,position:"relative",overflow:"hidden"}}>
      ...
      <img src="/logo.png" alt="" style={{position:"absolute",width:"600px",height:"600px",objectFit:"contain",opacity:0.15,pointerEvents:"none",zIndex:0,userSelect:"none"}} onError={e=>e.target.style.display="none"} />
